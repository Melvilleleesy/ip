...
public class TaskList implements Iterable<Task> {
    ...
    public String add(String type, String item) {
        assert type != null && item != null : "Type and item must not be null";
        ...
        switch (type) {
            ...
            case "deadline":
                ...
                if (deadlineParts == null) {
                    throw new DateTimeException("Invalid deadline format");
                }
            ...
            case "event":
                ...
                if (eventParts == null) {
                    throw new DateTimeException("Invalid event format");
                }
